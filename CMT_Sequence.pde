/* 
 * CMT_Sequence - generates expansion pitch sequence based on Chaos Melody Theory (CMT) of Elaine Walker
 *                (see http://www.ziaspace.com/elaine/chaos/ for more information on CMT)
 * Result of McGriff-Bruton Summer Internship, 2011
 * Sabria Farheen, supervised by Dr. Stephen P. Carl 
 * Version v.01 (7/27/2011)
 */

class CMT_Sequence extends Sequence {
  ...
  CMT_Polynomial poly = new CMT_Polynomial (0);

  public CMT_Sequence(int numNotes, int root, int type, float try_recur) {
